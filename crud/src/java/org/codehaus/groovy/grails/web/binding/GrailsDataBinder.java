// AlgoTrader: line 814 when updating associations look for +Impl classes
...
public class GrailsDataBinder extends ServletRequestDataBinder {
    ...
    public GrailsDataBinder(Object target, String objectName) {
        ...
        Object tmpTransients = GrailsClassUtils.getStaticPropertyValue(this.bean.getWrappedClass(), GrailsDomainClassProperty.TRANSIENT);
    ...
    private void setGrailsApplication(GrailsApplication grailsApplication) {
        ...
        if (grailsApplication != null && grailsApplication.isArtefactOfType(
            ...
            this.domainClass = (GrailsDomainClass) grailsApplication.getArtefact(DomainClassArtefactHandler.TYPE, target.getClass().getName());
        }
...
//        binder.setConversionService(conversionService);
    ...
    private Map resolveConstrainedProperties(Object object) {
        return resolveConstrainedProperties(object, (this.grailsApplication != null)?((GrailsDomainClass) this.grailsApplication.getArtefact(DomainClassArtefactHandler.TYPE, object.getClass().getName())):null);
    }
            ...
            if (propertyName.endsWith(IDENTIFIER_SUFFIX)) {
                ...
                if (isReadableAndPersistent(propertyName) && this.bean.isWritableProperty(propertyName)) {
                    if (NULL_ASSOCIATION.equals(pv.getValue())) {
                        ...
                        Class<?> propertyType = getPropertyTypeForPath(propertyName);
                        Class<?> type = this.grailsApplication.getArtefact("Domain", propertyType.getName() + "Impl").getClazz();
                        ...
                        if (persisted != null) {
                            ...
                            if (this.domainClass != null) {
                                GrailsDomainClassProperty property = this.domainClass.getPersistentProperty(propertyName);
                                if (property != null) {
    ...
    private Class<?> getReferencedTypeForCollection(String name, Object target) {
        if (this.grailsApplication != null) {
            GrailsDomainClass dc = (GrailsDomainClass) this.grailsApplication.getArtefact(

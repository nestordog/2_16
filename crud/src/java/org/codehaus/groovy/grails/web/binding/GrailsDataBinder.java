// AlgoTrader: line 703 - 711 look for className + "Impl"
/*
...
public class GrailsDataBinder extends ServletRequestDataBinder {
    ...
    private Map resolveConstrainedProperties(Object object) {
        GrailsApplication grailsApplication = ApplicationHolder.getApplication();
        return resolveConstrainedProperties(object, (grailsApplication != null) ? ((GrailsDomainClass) grailsApplication.getArtefact(DomainClassArtefactHandler.TYPE, object.getClass().getName()))
                : null);
    }
    ...
    private Class<?> getReferencedTypeForCollection(String name, Object target) {
        ...
        if (grailsApplication != null) {
            GrailsDomainClass dc = (GrailsDomainClass) grailsApplication.getArtefact(DomainClassArtefactHandler.TYPE, target.getClass().getName());
            if (dc != null) {

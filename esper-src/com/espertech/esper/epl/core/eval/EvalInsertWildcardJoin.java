...
public class EvalInsertWildcardJoin extends EvalBase implements SelectExprProcessor {

    private static final Log log = LogFactory.getLog(EvalInsertWildcardJoin.class);

    private final SelectExprJoinWildcardProcessor joinWildcardProcessor;

    public EvalInsertWildcardJoin(SelectExprContext selectExprContext, EventType resultEventType, SelectExprJoinWildcardProcessor joinWildcardProcessor) {

...
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (23,'MFVIX','CFE','USD',100,0.05,'1.87000','14:20:00','22:15:00','','',0,75,0,400,'MINUTE',29);
...
INSERT INTO `strategy` (`id`, `NAME`, `FAMILY`, `AUTO_ACTIVATE`, `ALLOCATION`, `MODULES`) VALUES (0,'BASE','BASE','',0.000,'market-data,current-values,market-data-simulation,trades,portfolio,performance,ib,algo');
...
INSERT INTO `strategy` (`id`, `NAME`, `FAMILY`, `AUTO_ACTIVATE`, `ALLOCATION`, `MODULES`) VALUES (5,'PERIODIC','PERIODIC','\0',0.000,'main');
...
INSERT INTO `watch_list_item` (`id`, `PERSISTENT`, `SECURITY_FK`, `STRATEGY_FK`, `UPPER_ALERT_VALUE`, `LOWER_ALERT_VALUE`) VALUES (282,'',40,5,NULL,NULL);
...
-- Dump completed on 2011-09-06 18:16:28

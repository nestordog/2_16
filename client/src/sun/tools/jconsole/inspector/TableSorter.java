// Algotrader: 139 do not log "sorting table against..."
/*
...
public class TableSorter extends DefaultTableModel implements MouseListener {
    ...
    public TableSorter() {
        super();
        this.evtListenerList = new Vector<TableModelListener>();
    }
    ...
    private void sort(int column, boolean isAscending) {
        final XMBeanAttributes attrs =
                (this.tableView instanceof XMBeanAttributes)
                ?(XMBeanAttributes) this.tableView
                :null;

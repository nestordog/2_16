/*
 * Copyright (c) 2006, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
...
import static sun.tools.jconsole.JConsole.IS_GTK;
...
abstract class OverviewPanel extends PlotterPanel {
    private static final Dimension PREFERRED_PLOTTER_SIZE = new Dimension(280, 200);
    ...
    public JLabel getInfoLabel() {
        if (this.infoLabel == null) {
            this.infoLabel = new JLabel("", CENTER) {
                @Override
            ...
            if (IS_GTK) {
                ...
                southPanel.add(this.infoLabel, BorderLayout.SOUTH);

...
CREATE TABLE `property` (
  ...
  `SUBSCRIPTION_FK` int(11) DEFAULT NULL,
  `STRATEGY_FK` int(11) DEFAULT NULL,
  `TRANSACTION_FK` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `PROPERTY_SUBSCRIPTION_FKC` (`SUBSCRIPTION_FK`),
  KEY `PROPERTY_POSITION_FKC` (`POSITION_FK`),
  KEY `PROPERTY_TRANSACTION_FKC` (`TRANSACTION_FK`),
  KEY `PROPERTY_STRATEGY_FKC` (`STRATEGY_FK`),
  CONSTRAINT `PROPERTY_TRANSACTION_FKC` FOREIGN KEY (`TRANSACTION_FK`) REFERENCES `transaction` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `PROPERTY_POSITION_FKC` FOREIGN KEY (`POSITION_FK`) REFERENCES `position` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `PROPERTY_STRATEGY_FKC` FOREIGN KEY (`STRATEGY_FK`) REFERENCES `strategy` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `PROPERTY_SUBSCRIPTION_FKC` FOREIGN KEY (`SUBSCRIPTION_FK`) REFERENCES `subscription` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2012-03-26 19:03:46

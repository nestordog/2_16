...
CREATE TABLE `account` (
  ...
  `BROKER` enum('IB','JPM','DC','RBS') DEFAULT NULL,
...
CREATE TABLE `bar` (
  ...
  `VOL` int(11) NOT NULL,
  `BAR_SIZE` enum('MSEC_1','SEC_1','MIN_1','MIN_2','MIN_5','MIN_15','MIN_30','HOUR_1','HOUR_2','DAY_1','DAY_2','WEEK_1','WEEK_2','MONTH_1','MONTH_2','MONTH_3','MONTH_6','MONTH_9','MONTH_18','YEAR_1','YEAR_2') NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `future_family` (
  ...
  `EXPIRATION_DISTANCE` enum('MSEC_1','SEC_1','MIN_1','MIN_2','MIN_5','MIN_15','MIN_30','HOUR_1','HOUR_2','DAY_1','DAY_2','WEEK_1','WEEK_2','MONTH_1','MONTH_2','MONTH_3','MONTH_6','MONTH_9','MONTH_18','YEAR_1','YEAR_2') NOT NULL,
  `LENGTH` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `implied_volatility` (
  `ID` int(11) NOT NULL,
  `DURATION` enum('MSEC_1','SEC_1','MIN_1','MIN_2','MIN_5','MIN_15','MIN_30','HOUR_1','HOUR_2','DAY_1','DAY_2','WEEK_1','WEEK_2','MONTH_1','MONTH_2','MONTH_3','MONTH_6','MONTH_9','MONTH_18','YEAR_1','YEAR_2') NOT NULL,
...
-- Dump completed on 2013-10-03 11:49:48

...
CREATE TABLE `combination` (
  ...
  CONSTRAINT `COMBINATIONIFKC` FOREIGN KEY (`ID`) REFERENCES `security` (`id`)
...
CREATE TABLE `component` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `SECURITY_FK_PARENT_SECURITY_FK` (`SECURITY_FK`,`PARENT_SECURITY_FK`),
  KEY `ALLOCATION_SECURITY_FKC` (`SECURITY_FK`),
  KEY `ALLOCATION_COMBINATION_FKC` (`PARENT_SECURITY_FK`),
  CONSTRAINT `ALLOCATION_PARENT_SECURITY_FKC` FOREIGN KEY (`PARENT_SECURITY_FK`) REFERENCES `security` (`id`) ON DELETE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=119350 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-03-22 16:04:39

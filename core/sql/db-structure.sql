...
CREATE TABLE `account` (
  ...
  `BROKER` enum('IB','JPM','DC','RBS','RT','LMAX','FXCM') DEFAULT NULL,
  `ORDER_SERVICE_TYPE` enum('IB_NATIVE','IB_FIX','JPM_FIX','DC_FIX','RT_FIX','LMAX_FIX','FXCM_FIX') NOT NULL,
...
CREATE TABLE `bar` (
  ...
  `FEED_TYPE` enum('IB','BB','DC','LMAX','FXCM') DEFAULT NULL,
...
CREATE TABLE `holiday` (
  ...
  CONSTRAINT `HOLIDAY_MARKET_FKC` FOREIGN KEY (`EXCHANGE_FK`) REFERENCES `exchange` (`ID`)
...
-- Dump completed on 2014-06-28 16:14:06

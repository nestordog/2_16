...
public class AbstractDao<E extends BaseEntityI> {
    ...
    public E get(final int id, final LockOptions lockOptions) {
        ...
        Object result;
        if (lockOptions == null) {
            result = currentSession.get(entityClass, id);
        } else {
            result = currentSession.get(entityClass, id, lockOptions);
        }
        if (result != null) {
    ...
    public E load(final int id, final LockOptions lockOptions) {
        ...
        Object result;
        if (lockOptions == null) {
            result = currentSession.load(entityClass, id);
        } else {
            result = currentSession.load(entityClass, id, lockOptions);
        }
        return entityClass.cast(result);
    }
    ...
    public E persist(final E entity) {
        ...
        if (entity.getId() == 0) {
            ...
            return entityClass.cast(currentSession.merge(entity));
        }
        return entity;
    }

 ...
 * 8004 Zurich
 ***********************************************************************************/
package ch.algotrader.wiring.server.jpm;
...
public class JPMFixWiring {
    ...
    public FixApplicationFactory createJPMOrderApplicationFactory(final LookupService lookupService,
            final Engine serverEngine,
            final FixSessionStateHolder jPMOrderSessionStateHolder) {

        GenericFix42OrderMessageHandler genericFix42OrderMessageHandler = new GenericFix42OrderMessageHandler(lookupService, serverEngine);

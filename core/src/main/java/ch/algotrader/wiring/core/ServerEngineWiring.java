...
import ch.algotrader.esper.SpringServiceResolver;
...
public class ServerEngineWiring {
    ...
    public Engine createServerEngine(final ConfigParams configParams, final ApplicationContext applicationContext) throws Exception {
        ...
        EngineFactory engineFactory = new EngineFactory(new SpringServiceResolver("server", configParams, applicationContext), configParams);

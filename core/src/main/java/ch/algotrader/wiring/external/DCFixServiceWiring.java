...
public class DCFixServiceWiring {
    ...
    public SimpleOrderExecService createDCFixOrderService(
        ...
        return new DCFixOrderServiceImpl(fixAdapter, orderBook, orderPersistenceService, orderDao, accountDao, commonConfig);
    }

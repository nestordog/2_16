...
public class TestGenericOrderMessageFactory {
    ...
    public void setup() throws Exception {
        ...
        this.requestFactory = new GenericFix44OrderMessageFactory(new GenericFix44SymbologyResolver());
    }
    ...
    public void testLimitedOrderStock() throws Exception {
        ...
        SecurityFamily family = new SecurityFamilyImpl();
        family.setCurrency(Currency.USD);
        family.setTickSizePattern("0<0.01");
    ...
    @Test
    public void testtOrderWithProperties() throws Exception {

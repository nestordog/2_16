...
public class CurrentValuesEsperTest extends EsperTestBase {
    ...
    public void testInsertTick() throws Exception {
        ...
        TickVO tick1 = new TickVO(0L, new Date(), FeedType.IB.name(), 1L, new BigDecimal("1.11"), new Date(), new BigDecimal("1.12"), new BigDecimal("1.1"), 0, 0, 0);
        epRuntime.sendEvent(tick1);
        TickVO tick2 = new TickVO(0L, new Date(), FeedType.IB.name(), 2L, new BigDecimal("1.21"), new Date(), new BigDecimal("1.22"), new BigDecimal("1.2"), 0, 0, 0);
        epRuntime.sendEvent(tick2);
        TickVO tick3 = new TickVO(0L, new Date(), FeedType.IB.name(), 1L, new BigDecimal("1.12"), new Date(), new BigDecimal("1.13"), new BigDecimal("1.11"), 0, 0, 0);
        epRuntime.sendEvent(tick3);
        TickVO tick4 = new TickVO(0L, new Date(), FeedType.LMAX.name(), 2L, new BigDecimal("1.22"), new Date(), new BigDecimal("1.23"), new BigDecimal("1.21"), 0, 0, 0);
        ...
        Assert.assertEquals(FeedType.IB.name(), entry2.get("feedType"));

...
public class FTXFixOrderMessageHandlerTest extends FixApplicationTestBase {
    ...
    public void setup() throws Exception {
        ...
        FTXFixOrderMessageHandler messageHandlerImpl = new FTXFixOrderMessageHandler(this.orderExecutionService);
        ...
        DefaultFixApplication fixApplication = new DefaultFixApplication(sessionId, this.messageHandler, logonMessageHandler,
                new DefaultFixSessionStateHolder("FTX", Mockito.mock(EventDispatcher.class)));
    ...
    public void testLimitOrderModifyCancel() throws Exception {
        ...
        modifiedOrder.setLimit(new BigDecimal("1.0"));
        ...
        OrderCancelReplaceRequest message2 = this.messageFactory.createModifyOrderMessage(modifiedOrder, orderId2, 0);

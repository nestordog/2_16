...
INSERT INTO `future_family` (`ID`, `INTREST`, `DIVIDEND`, `MARGIN_PARAMETER`, `EXPIRATION_TYPE`) VALUES (10,0.0015000000,0.0300000000,490.9000000000,'NEXT_3_RD_FRIDAY_3_MONTHS');
INSERT INTO `future_family` (`ID`, `INTREST`, `DIVIDEND`, `MARGIN_PARAMETER`, `EXPIRATION_TYPE`) VALUES (22,0.0015000000,0.0300000000,490.9000000000,'THIRTY_DAYS_BEFORE_NEXT_3_RD_FRIDAY');
...
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (3,'DE000A0C3QF1','V2TX',NULL,NULL,5,NULL);
...
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (5,'CH0019900841','V3X',NULL,NULL,7,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (6,'CH0007475228','CHFDOMDEP1W',NULL,NULL,6,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (7,'CH0007473702','CHFDOMDEP1M',NULL,NULL,6,NULL);
...
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (12,'SPY','SPY',NULL,NULL,11,NULL);
...
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (21,'UX1','UX1',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (22,'UX2','UX2',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (23,'UX3','UX3',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (24,'UX4','UX4',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (25,'UX5','UX5',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (26,'UX6','UX6',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (27,'UX7','UX7',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (28,'UX8','UX8',12,NULL,21,NULL);
INSERT INTO `security` (`id`, `ISIN`, `SYMBOL`, `UNDERLAYING_FK`, `VOLATILITY_FK`, `SECURITY_FAMILY_FK`, `INTREST_RATE_FAMILY_FK`) VALUES (29,'VIX','VIX',12,NULL,20,NULL);
...
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (8,'CHF FOREX','IDEALPRO','CHF',1,5e-005,'0.00000','09:00:00','18:00:00','','\0',0,0.0001,0,0.0004,'HOUR',NULL);
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (9,'USD FOREX','IDEALPRO','USD',1,5e-005,'0.00000','09:00:00','18:00:00','','\0',0,0.0001,0,0.0004,'HOUR',NULL);
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (10,'FSMI','SOFFEX','CHF',10,1,'4.00000','07:50:00','22:00:00','','',0.0003,0,0.037,25,'MINUTE',4);
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (11,'SPY','SMART','USD',1,0.01,'0.00000','15:30:00','22:00:00','','\0',NULL,NULL,NULL,NULL,'MINUTE',NULL);
...
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (21,'UX','CFE','USD',1000,0.05,NULL,'13:20:00','21:15:00','\0','\0',NULL,NULL,NULL,NULL,'MINUTE',12);
INSERT INTO `security_family` (`id`, `NAME`, `MARKET`, `CURRENCY`, `CONTRACT_SIZE`, `TICK_SIZE`, `COMMISSION`, `MARKET_OPEN`, `MARKET_CLOSE`, `TRADEABLE`, `SIMULATABLE`, `SPREAD_SLOPE`, `SPREAD_CONSTANT`, `MAX_SPREAD_SLOPE`, `MAX_SPREAD_CONSTANT`, `PERIODICITY`, `UNDERLAYING_FK`) VALUES (22,'FVIX','CFE','USD',1000,0.05,'1.85000','13:20:00','21:15:00','','',0,100,0,200,'MINUTE',12);
...
INSERT INTO `strategy` (`id`, `NAME`, `FAMILY`, `AUTO_ACTIVATE`, `ALLOCATION`, `MODULES`) VALUES (4,'EASTWEST','EASTWEST','',1.000,'volcarry-main');
...
INSERT INTO `tick` (`id`, `DATE_TIME`, `LAST`, `LAST_DATE_TIME`, `VOL`, `VOL_BID`, `VOL_ASK`, `BID`, `ASK`, `OPEN_INTREST`, `SETTLEMENT`, `SECURITY_FK`) VALUES (1,'2004-01-01 00:00:00',NULL,NULL,0,0,0,'1.00000','1.00000',0,'0.00000',10);
...
INSERT INTO `transaction` (`id`, `NUMBER`, `DATE_TIME`, `QUANTITY`, `PRICE`, `COMMISSION`, `CURRENCY`, `TYPE`, `DESCRIPTION`, `SECURITY_FK`, `STRATEGY_FK`, `POSITION_FK`) VALUES (1,NULL,'1990-01-01 00:00:00',1,'1000000.00000','0.00','EUR','CREDIT',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2011-07-06 13:21:08

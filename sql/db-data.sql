...
INSERT INTO `equity_index` (`ID`) VALUES (2),(3),(4),(5),(12),(29);
...
INSERT INTO `future_family` (`ID`, `INTREST`, `DIVIDEND`, `MARGIN_PARAMETER`, `EXPIRATION_TYPE`) VALUES (10,0.0015000000,0.0300000000,490.9000000000,'NEXT_3_RD_FRIDAY_3_MONTHS'),(22,0.0015000000,0.0300000000,490.9000000000,'THIRTY_DAYS_BEFORE_NEXT_3_RD_FRIDAY');
...
INSERT INTO `generic_future_family` (`ID`, `EXPIRATION_TYPE`) VALUES (12,'NEXT_3_RD_FRIDAY'),(13,'NEXT_3_RD_FRIDAY'),(14,'NEXT_3_RD_FRIDAY'),(21,'THIRTY_DAYS_BEFORE_NEXT_3_RD_FRIDAY');
...
INSERT INTO `stock_option_family` (`ID`, `STRIKE_DISTANCE`, `INTREST`, `DIVIDEND`, `MARGIN_PARAMETER`, `EXPIRATION_TYPE`) VALUES (3,50.0000000000,0.0015000000,0.0300000000,0.0750000000,'NEXT_3_RD_FRIDAY'),(6,50.0000000000,0.0060000000,0.0300000000,0.0750000000,'NEXT_3_RD_FRIDAY');
...
INSERT INTO `strategy` (`id`, `NAME`, `FAMILY`, `AUTO_ACTIVATE`, `ALLOCATION`, `MODULES`) VALUES (0,'BASE','BASE','',0.000,'base'),(1,'SMI','THETA','\0',0.000,'theta-init,theta-main'),(2,'ESTX50','THETA','\0',0.000,'theta-init,theta-main'),(3,'MULTIIND','MULTIIND','\0',0.000,'multiind-movavcross,multiind-main'),(4,'EASTWEST','EASTWEST','',1.000,'volcarry-main');
...
INSERT INTO `watch_list_item` (`id`, `PERSISTENT`, `SECURITY_FK`, `STRATEGY_FK`) VALUES (1,'',2,2),(2,'',3,2),(3,'',4,1),(4,'',8,1),(5,'',5,1),(6,'',12,3),(7,'',13,3),(8,'',14,3),(9,'',15,3),(10,'',29,4),(11,'',21,4),(12,'',22,4),(13,'',23,4),(14,'',24,4),(15,'',25,4),(16,'',26,4),(17,'',27,4),(18,'',28,4);

...
D:\AlgoTrader\sql\db-structure.sql ^
algotrader
...
-c -t -u @localhost ^
-r D:\AlgoTrader\sql\db-data.sql ^
algotrader
...
-c -t -u @localhost ^
-r D:\AlgoTrader\sql\db-data-live.sql ^
algotraderlive
...
"D:\AlgoTrader\sql\unix2dos.exe" D:\AlgoTrader\sql\db-data-live.sql
